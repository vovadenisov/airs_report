...
SECRET_KEY = config_get('global', 'SECRET_KEY')
...
DATABASES = {
    'default': {
        'ENGINE': config_get('database_default', 'DATABASE_BACKEND'),
...
MEDIA_ROOT = config_get('global', 'MEDIA_ROOT')
MEDIA_URL = config_get('global', 'MEDIA_URL')
STATIC_ROOT = config_get('global', 'STATIC_ROOT')

SITE_URL = config_get('global', 'SITE_URL')
